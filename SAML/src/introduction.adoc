...
prevoisly known as the Government of Canada Credential Federation (GCCF).
...
The scope of this profile applies only to providers and consumers of
anonymous credential authentication services. A separate complementary profile
will be developed for identity authentication services.
